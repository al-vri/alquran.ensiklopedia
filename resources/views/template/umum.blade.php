							...
							<div class="pencarian">
								<form method="POST" action="{{ URL::to('cari') }}">
									...
									<div class="input-group">
										...
										<input type="text" name="katakunci" class="input" placeholder="Cari..." value="@if (!empty($katakunci)){{ $katakunci }}@endif" required>
									</div>
								</form>
							</div>
						@endif
						...
						<div class="contact100-more flex-col-c-m" style="background-image: url('/assets/gambar/bg-kontak.jpg');">
							...
							<div class="dis-flex size1 p-b-47">
								...
								<div class="flex-col size2">
									...
									<span class="txt3">
										Jalan Sandrageni Nomor 19,
										RT 005/RW 002, Desa Kertaharja,
